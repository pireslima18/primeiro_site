...
<html>
	<head>
		...
		<script type="text/javascript" src="script_tarefas_pendentes.js"></script>
		...
		<nav class="navbar navbar-light bg-light">
			<div class="container">
				<a class="navbar-brand" href="#">
					...
					<span class="texto-nav">App Lista-Tarefas</span>
				</a>
				<ul class="navbar-nav">
					<li class="nav-item">
						<a class="nav-link text-dark" href="logoff.php">SAIR</a>
					</li>
				</ul>
			</div>
		</nav>
